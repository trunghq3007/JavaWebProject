...
<body>
	<%-- use jsp to connect and retrieve data --%>
	<%
		...
		connect = DriverManager.getConnection(
				"" + "jdbc:sqlserver://localhost:1433;databaseName=NORTHWND;user=sa;password=1234567");
	...
	<sql:setDataSource var="snapshot"
		...
		url="jdbc:sqlserver://localhost:1433" user="sa" password="1234567" />


	<%-- insert --%>
	<sql:update dataSource="${snapshot}" var="result">
	INSERT INTO Employees (FirstName,LastName) VALUES ('Ha', 'Quang Trung');
	</sql:update>
